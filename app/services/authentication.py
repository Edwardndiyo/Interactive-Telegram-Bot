...
#  down there works perfeclty updating codebase to bypass need for users to enter email address manually, instead were grabbing the number and filtering through our database to get the registered mail
